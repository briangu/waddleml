...
Run directly via `python3 -m examples.ml_sample --epochs 50` or integrate with
the Waddle CLI: `python waddle/waddle_cli.py run --repo main --entry examples.ml_sample -- --epochs 50`.
"""
